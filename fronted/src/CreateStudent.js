...
function CreateStudent({ onAddStudent }) {
    ...
    const handleHobbiesChange = (selectedHobby) => {
    ...
    return (
        <div className="d-flex vh-100 bg-light justify-content-center align-items-center myClass">
